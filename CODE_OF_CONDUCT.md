...
reported to the maintainers via the private reporting channel described in
[`SECURITY.md`](SECURITY.md) (for anything sensitive) or via a project
issue for less sensitive matters. All complaints will be reviewed and
...
4. **Permanent ban** -- A permanent ban from any sort of public interaction
   within the project, for a pattern of violation, harassment, or
   aggression.
